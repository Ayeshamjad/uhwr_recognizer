...
from .mulit_modality import MultiModalCNNEncoder
...
class JointMultiModel(nn.Module):
    ...
    def __init__(self, trans_enc_d_model, trans_enc_nhead, trans_enc_layers, trans_enc_ff_dim,
                 tokenizer, trans_dec_d_model, trans_dec_nhead, trans_dec_layers, trans_dec_n_positions, freeze_decoder=True, encoder_path=None, decoder_path=None, cnn_encoder_path=None, ctc_head_path=None):
        super().__init__()
        self.cnn_encoder = MultiModalCNNEncoder(cnn_encoder_path=cnn_encoder_path)
